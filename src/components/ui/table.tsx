            ...
            <>
              <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  {columnVisibility && (
                    <DropdownMenu>
                      <DropdownMenuTrigger render={<Button variant='outline' className='gap-2' />}><Eye className='h-4 w-4' />View
          ...
          <div className='flex items-center gap-4'>
            ...
            {showPageSizeSelector && (
              <div className='flex items-center gap-2'>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger render={<Button variant='outline' className='w-20 justify-between' />}>{table.getState().pagination.pageSize}<ChevronDown className='ml-2 h-4 w-4' /></DropdownMenuTrigger>
