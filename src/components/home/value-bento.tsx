...
export function ValueBento() {
  return (
    <section className="mx-auto max-w-screen-2xl px-6 py-16 xl:px-8">
      ...
      <Link
        href={ROUTES.RESOURCES}
        className="mt-8 flex items-center justify-between gap-4 rounded-2xl border border-border/50 bg-linear-to-r from-primary/[0.04] to-brand/[0.04] px-6 py-5 transition-all duration-200 hover:border-primary/20 hover:shadow-md"
      >
